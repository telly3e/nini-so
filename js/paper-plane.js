...
class paperPlane extends HTMLElement {
  constructor() {
    super();
    this.attachShadow({ mode: 'open' });
    this.shadowRoot.appendChild(paperPlaneTemplate.content.cloneNode(true));
  }
  connectedCallback() {
    document.body.style.cssText = 'background-color: #85b9dd;'
  }
...
window.customElements.define('paper-plane', paperPlane);